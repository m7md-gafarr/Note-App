...
import 'package:note_taking_app/src/data/model/AvatarModel.dart';

const Color color1 = Color(0xff686868);
String hiveBox = "NotesBox";
...
const String architectsDaughterFont = "ArchitectsDaughter";
